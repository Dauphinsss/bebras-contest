/* eslint-disable */
// Generated by Wrangler by running `wrangler types backend/src/worker-configuration.d.ts` (hash: c377df5d3b5a61107499efc9d6a5caae)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REGISTRATION_ONLY" | "FRONTEND_ORIGIN" | "FIREBASE_PROJECT_ID">> {}
}

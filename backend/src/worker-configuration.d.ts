/* eslint-disable */
// Generated by Wrangler by running `wrangler types backend/src/worker-configuration.d.ts` (hash: be306e3aa3fdf077f3e17ba7a7cbb92e)
// Runtime types generated with workerd@1.20260910.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	UPLOADS: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	REGISTRATION_ONLY: "false" | "true";
	FRONTEND_ORIGIN: "" | "http://localhost:4321";
	PASSWORDS: DurableObjectNamespace<import("./index").PasswordService>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "PasswordService";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REGISTRATION_ONLY" | "FRONTEND_ORIGIN">> {}
}
